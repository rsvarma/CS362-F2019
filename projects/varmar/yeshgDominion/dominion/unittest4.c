...
int test_baron(){
    ...
    //run function
    playBaron(1,0,0,&initial,0,&bonus,0);
    ...
    //run function
    playBaron(0,0,0,&initial,0,&bonus,0);
    ...
    successful = 0;
    printf("Test 3: Player 0 chooses to discard an estate, but doesn't have estate:\n\n");
    //Pre Game State Requirements: Player 0 has baron in hand
    //Post Game State Requirements: Player 0 gains an estate
    initial = G;
    //set pre game state
    ...
    //run function
    int r = playBaron(1,0,0,&initial,0,&bonus,0);
