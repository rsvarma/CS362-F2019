...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        return handle_mine(choice1,choice2,handPos, state,currentPlayer);
    ...
    case baron:
        return handle_baron(choice1,state,currentPlayer);
    ...
    case minion:
        return handle_minion(choice1, choice2, handPos, state, currentPlayer);
    ...
    case tribute:
        return handle_tribute(state,currentPlayer);

    case ambassador:
        return handle_ambassador(choice1,choice2,handPos,state,currentPlayer);
